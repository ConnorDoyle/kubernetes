...
func (in *PriorityArgument) DeepCopyInto(out *PriorityArgument) {
	*out = *in
	...
	if in.ResourceBinPacking != nil {
		in, out := &in.ResourceBinPacking, &out.ResourceBinPacking
		*out = new(ResourceBinPacking)
		**out = **in
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ResourceBinPacking) DeepCopyInto(out *ResourceBinPacking) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ResourceBinPacking.
func (in *ResourceBinPacking) DeepCopy() *ResourceBinPacking {
	if in == nil {
		return nil
	}
	out := new(ResourceBinPacking)
