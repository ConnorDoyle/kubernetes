...
func (in *PriorityArgument) DeepCopyInto(out *PriorityArgument) {
	*out = *in
	...
	if in.ScarceResourceBinPacking != nil {
		in, out := &in.ScarceResourceBinPacking, &out.ScarceResourceBinPacking
		*out = new(ScarceResourceBinPacking)
		**out = **in
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ScarceResourceBinPacking) DeepCopyInto(out *ScarceResourceBinPacking) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ScarceResourceBinPacking.
func (in *ScarceResourceBinPacking) DeepCopy() *ScarceResourceBinPacking {
	if in == nil {
		return nil
	}
	out := new(ScarceResourceBinPacking)
